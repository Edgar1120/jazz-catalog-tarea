...
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-PUowDtHk.mjs';
import { a as useContentPreview } from './preview-CzMU26dm.mjs';
import { c as useNuxtApp, a as __nuxt_component_0, b as useRuntimeConfig } from './server.mjs';
import '../_/nitro.mjs';
import 'unified';
import 'remark-parse';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DjD_jX8M.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-CEOqiBFr.mjs.map
